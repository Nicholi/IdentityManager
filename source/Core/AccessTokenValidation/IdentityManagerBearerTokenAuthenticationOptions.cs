...
{
    /// <summary>
    /// Configures identity manager token validation
    /// </summary>
    public class IdentityManagerBearerTokenAuthenticationOptions : AuthenticationOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityManagerBearerTokenAuthenticationOptions"/> class.
        /// </summary>
        public IdentityManagerBearerTokenAuthenticationOptions() : base("Bearer")
        {
            NameClaimType = "name";
            RoleClaimType = "role";
