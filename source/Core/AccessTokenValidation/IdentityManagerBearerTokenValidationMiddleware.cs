...
namespace IdentityManager.AccessTokenValidation
{
    /// <summary>
    /// Middleware for validating identitymanager access tokens
    /// </summary>
    public class IdentityManagerBearerTokenValidationMiddleware
    {
        private readonly AppFunc _next;
        private readonly AppFunc _localValidationFunc;
        private readonly AppFunc _endpointValidationFunc;
        private readonly IdentityManagerOAuthBearerAuthenticationOptions _options;
        private readonly ILogger _logger;

        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityManagerBearerTokenValidationMiddleware" /> class.
        /// </summary>
        /// <param name="next">The next middleware.</param>
        /// <param name="options">The options.</param>
        /// <param name="loggerFactory">The logger factory.</param>
        public IdentityManagerBearerTokenValidationMiddleware(AppFunc next, IdentityManagerOAuthBearerAuthenticationOptions options, ILoggerFactory loggerFactory)
        {
            _next = next;
            _options = options;
        ...
        public async Task Invoke(IDictionary<string, object> environment)
        {
            ...
            context.Set("idmgr:tokenvalidation:token", token);
