...
{
    /// <summary>
    /// Token provider that returns the token already found by the identitymanager token middleware
    /// </summary>
    public class ContextTokenProvider : IOAuthBearerAuthenticationProvider
    {
        ...
        {
            context.Token = context.OwinContext.Get<string>("idmgr:tokenvalidation:token");
