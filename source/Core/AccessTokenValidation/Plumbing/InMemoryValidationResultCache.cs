...
namespace IdentityManager.AccessTokenValidation
{
    ...
    {
        private readonly IdentityManagerBearerTokenAuthenticationOptions _options;
        ...
        public InMemoryValidationResultCache(IdentityManagerBearerTokenAuthenticationOptions options)
        ...
        /// cache
        /// </exception>
        public InMemoryValidationResultCache(IdentityManagerBearerTokenAuthenticationOptions options, IClock clock, ICache cache)
        {
